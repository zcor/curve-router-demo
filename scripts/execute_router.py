...
# Setup contracts
router_path = "contracts/Router.vy"
router_deployer = boa.load_partial(router_path)
router_contract = router_deployer.deploy()
...
# Confirm Swap
dx = 10**18
quote_value = router_contract.quote_weth_usdc_router(dx)
...
weth.approve(router_contract, dx)
router_contract.swap_weth_usdc_router(dx, 0)
